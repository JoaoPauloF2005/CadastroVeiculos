  ...
  <center>
    <div class="container-fluid">
      <div class="box-search">
        <form action="/combustivel/buscar" method="GET">
          ...
          <thead> 
            ...
            <tr>
              <?php foreach ($model->rows as $Combustivel) : ?>
                ...
                <td scope="col"><?= $Combustivel->nome?></td>
                <td scope="col"></td>
                
               
                <td scope="col"><a class='btn btn-sm btn-primary' href="/combustivel/form?id=<?= $Combustivel->id ?>" title='Editar'>
                ...
                <td scope="col">
                  <a class='btn btn-sm btn-danger' href="/combustivel/delete?id=<?= $Combustivel->id ?>" id="<?= $Combustivel->id ?>" title='Deletar'>
