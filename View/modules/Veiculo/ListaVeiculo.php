          ...
          <tbody>
            <tr>
              <?php foreach ($model->rows as $Veiculo) : ?>
                <td scope="col"> <?= $Veiculo->id ?></td>
                <td scope="col"> <?= $Veiculo->Marca ?> </td>
                <td scope="col"> <?= $Veiculo->Modelo ?></td>
                <td scope="col"> <?= $Veiculo->Fabricante ?></td>
                <td scope="col"> <?= $Veiculo->Tipo ?></td>
                <td scope="col"> <?= $Veiculo->Ano ?></td>
                <td scope="col"> <?= $Veiculo->Combustivel ?></td>
                <td scope="col"> <?= $Veiculo->Cor ?></td>
                <td scope="col"> <?= $Veiculo->NumeroChassi ?></td>
                <td scope="col"> <?= $Veiculo->Kilometragem ?></td>
              
                <td scope="col"><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter">
                    Ver detalhes
                  </button>
                </td>
                <td scope="col">
                  <a class='btn btn-sm btn-primary' href="/veiculo/form?id=<?= $Veiculo->id ?>" title='Editar'>
