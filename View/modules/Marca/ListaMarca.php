...
<center>
    <div class="container-fluid">
      <div class="box-search">
        <form action="/marca/buscar" method="GET">
          ...
          <thead> 
            ...
            <tr>
              <?php foreach ($model->rows as $Marca) : ?>
                <td> <?= $Marca->id ?></td>
                <td scope="col"><?= $Marca->nome?></td>
                <td scope="col"></td>
                
               
                <td scope="col"><a class='btn btn-sm btn-primary' href="/marca/form?id=<?= $Marca->id ?>" title='Editar'>
                ...
                <td scope="col">
                  <a class='btn btn-sm btn-danger' href="/marca/delete?id=<?= $Marca->id ?>" id="<?= $Marca->id ?>" title='Deletar'>
