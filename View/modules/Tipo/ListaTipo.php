...
<center>
    <div class="container-fluid">
      <div class="box-search">
        <form action="/tipo/buscar" method="GET">
          ...
          <thead> 
            ...
            <tr>
              <?php foreach ($model->rows as $Tipo) : ?>
                <td> <?= $Tipo->id ?></td>
                <td scope="col"><?= $Tipo->nome?></td>
                <td scope="col"></td>
                
               
                <td scope="col"><a class='btn btn-sm btn-primary' href="/tipo/form?id=<?= $Tipo->id ?>" title='Editar'>
                ...
                <td scope="col">
                  <a class='btn btn-sm btn-danger' href="/tipo/delete?id=<?= $Tipo->id ?>" id="<?= $Tipo->id ?>" title='Deletar'>
