                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="#" class="dropdown-toggle" data-toggle="dropdown">Cadastrar <span class="caret"></span></a>
                            <ul class="dropdown-menu">
                                <li><a href="/combustivel/form">Combustivel</a></li>
                                <li><a href="/fabricante/form">Fabricante</a></li>
                                <li><a href="/marca/form">Marca</a></li>
                                <li><a href="/tipo/form">Tipo</a></li>
                                <li><a href="/veiculo/form">Veiculo</a></li>
